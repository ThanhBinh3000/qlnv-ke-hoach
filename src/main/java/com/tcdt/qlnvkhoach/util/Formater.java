...
public class Formater {
	private static final SimpleDateFormat sdfErp = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	public static Date sdfErp(String dateStr) throws ParseException {
		return sdfErp.parse(dateStr);
	}

	public static String sdfErp(Date date) throws ParseException {
		return sdfErp.format(date);
	}
	...
	public static Date date2ddsmmsyyyspHHmmss(String dateStr) throws ParseException {
		return sdfddsmmsyyyspHHmmss.parse(dateStr);
	}
