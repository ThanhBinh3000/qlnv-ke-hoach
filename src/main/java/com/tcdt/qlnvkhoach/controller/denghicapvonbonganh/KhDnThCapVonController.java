...
public class KhDnThCapVonController {
    ...
    @ApiOperation(value = "Chi tiết Quản lý Tổng hợp đề nghị cấp vốn DTQG", response = List.class)
    @GetMapping("/{id}")
    public ResponseEntity<Resp> detail(@PathVariable Long id) {
        ...
        try {
            ...
            resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
            resp.setMsg(e.getMessage());
            log.error("Chi tiết Quản lý Tổng hợp đề nghị cấp vốn DTQG lỗi: {}", e);
        }
        return ResponseEntity.ok(resp);
    }

    @ApiOperation(value = "Phê duyệt/ từ chối Quản lý Tổng hợp đề nghị cấp vốn DTQG", response = List.class)
    @PutMapping("/status")
    public ResponseEntity<Resp> updateStatus(@Valid @RequestBody StatusReq req) {
        ...
        try {
            ...
            resp.setStatusCode(EnumResponse.RESP_FAIL.getValue());
            resp.setMsg(e.getMessage());
            log.error("Phê duyệt/ từ chối Quản lý Tổng hợp đề nghị cấp vốn DTQG lỗi: {}", e);
        }
        return ResponseEntity.ok(resp);
    }

    @ApiOperation(value = "Tra cứu Quản lý Tổng hợp đề nghị cấp vốn DTQG", response = List.class)
    @GetMapping()
    public ResponseEntity<Resp> search(KhDnThCapVonSearchRequest req) {
        Resp resp = new Resp();
        try {
    ...
    @ApiOperation(value = "Delete multiple Tổng hợp đề nghị cấp vốn DTQG", response = List.class)
    ...
    public final ResponseEntity<Resp> deleteMultiple(@RequestBody @Valid DeleteReq req) {
        ...
        try {
            ...
            resp.setMsg(e.getMessage());
            resp.setMsg(e.getMessage());
            log.error("Delete multiple Tổng hợp đề nghị cấp vốn DTQG lỗi ", e);
        }
        return ResponseEntity.ok(resp);
    }

    @ApiOperation(value = "Export Tổng hợp đề nghị cấp vốn DTQG", response = List.class)
