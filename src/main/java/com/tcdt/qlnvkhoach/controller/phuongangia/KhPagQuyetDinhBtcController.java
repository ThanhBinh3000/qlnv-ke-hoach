...
public class KhPagQuyetDinhBtcController extends BaseController {
  ...
  @PostMapping(value = URL_QD_GIA_BTC + URL_TRA_CUU, produces = MediaType.APPLICATION_JSON_VALUE)
  public final ResponseEntity<Resp> search(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody KhPagQuyetDinhBtcSearchReq objReq) {
    Resp resp = new Resp();
    try {
      resp.setData(khPagLtQuyetDinhBtcService.searchPage(currentUser, objReq));
  ...
  @PostMapping(value = URL_QD_GIA_BTC + URL_TAO_MOI, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @PostMapping(value = URL_QD_GIA_BTC + URL_CAP_NHAT, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @PostMapping(value = URL_QD_GIA_BTC + URL_XOA_MULTI, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(value = URL_QD_GIA_BTC + URL_CHI_TIET, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @PostMapping(value = URL_QD_GIA_BTC + URL_KET_XUAT, produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(HttpStatus.OK)
  public void export(@CurrentUser CustomUserDetails currentUser, @Valid @RequestBody KhPagQuyetDinhBtcSearchReq objReq, HttpServletResponse response) throws Exception {
    try {
      khPagLtQuyetDinhBtcService.export(currentUser, objReq, response);
    } catch (Exception e) {
  ...
  @PostMapping(value = URL_QD_GIA_BTC + URL_PHE_DUYET, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @ApiOperation(value = "Danh sách tờ trình đề xuất lương thực cho quyết định BTC", response = List.class)
  @PostMapping(value = URL_QD_GIA_BTC + URL_DANH_SACH_TO_TRINH_TONG_HOP, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @ApiOperation(value = "Danh sách thông tin giá của tờ trình đề xuất lương thực cho quyết định BTC", response = List.class)
  @GetMapping(value = URL_QD_GIA_BTC + URL_DANH_SACH_TO_TRINH_TONG_HOP + URL_CHI_TIET, produces = MediaType.APPLICATION_JSON_VALUE)
  public final ResponseEntity<Resp> DsToTrinhTongHopChiTiet(@PathVariable("ids") Long ids) {
    Resp resp = new Resp();
    try {
      resp.setData(khPagLtQuyetDinhBtcService.DsToTrinhDeXuatChiTietLt(Arrays.asList(ids)));
      resp.setStatusCode(Constants.RESP_SUCC);
      resp.setMsg("Thành công");
    } catch (Exception e) {
      resp.setStatusCode(Constants.RESP_FAIL);
  ...
  @ApiOperation(value = "Danh sách tờ trình đề xuất vật tư cho quyết định BTC", response = List.class)
  @PostMapping(value = URL_QD_GIA_BTC + URL_DANH_SACH_TO_TRINH_DE_XUAT, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @ApiOperation(value = "Danh sách thông tin giá của tờ trình đề xuất vật tư cho quyết định BTC", response = List.class)
  @GetMapping(value = URL_QD_GIA_BTC + URL_DANH_SACH_TO_TRINH_DE_XUAT + URL_CHI_TIET, produces = MediaType.APPLICATION_JSON_VALUE)
  public final ResponseEntity<Resp> DsToTrinhDeXuatChiTiet(@PathVariable("ids") Long ids) {
    Resp resp = new Resp();
    try {
      resp.setData(khPagLtQuyetDinhBtcService.DsToTrinhDeXuatChiTietVt(Arrays.asList(ids)));
      resp.setStatusCode(Constants.RESP_SUCC);
      resp.setMsg("Thành công");
    } catch (Exception e) {
      resp.setStatusCode(Constants.RESP_FAIL);
