package com.tcdt.qlnvkhoachphi.jwt;
...
import com.tcdt.qlnvkhoachphi.RequestService;
import com.tcdt.qlnvkhoachphi.service.UserService;
import com.tcdt.qlnvkhoachphi.table.UserAction;
import com.tcdt.qlnvkhoachphi.table.UserHistory;
import com.tcdt.qlnvkhoachphi.util.MapAction;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			if (StringUtils.hasText(jwt) && TokenAuthenticationService.validateToken(jwt)) {
				...
				authentication = TokenAuthenticationService.getAuthentication(request, userDetails);
			...
			if (request instanceof HttpServletRequest && authentication != null) {
				performRequestAudit(request, authentication);
			}
		}
	}
