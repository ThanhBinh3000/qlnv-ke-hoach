...
@Entity
@Table(name = "QLNV_KHVONPHI_TC_KHOACH_DTAO_BOI_DUONG_GD3N")
@Data
public class QlnvKhvonphiTcKhoachDtaoBoiDuongGd3n implements Serializable {
	/**
	 *
	 */
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QLNV_KHVONPHI_TC_KHOACH_DTAO_BOI_DUONG_GD3N_SEQ")
	@SequenceGenerator(sequenceName = "QLNV_KHVONPHI_TC_KHOACH_DTAO_BOI_DUONG_GD3N_SEQ", allocationSize = 1, name = "QLNV_KHVONPHI_TC_KHOACH_DTAO_BOI_DUONG_GD3N_SEQ")
	private Long id;
