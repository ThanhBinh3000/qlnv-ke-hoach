...
@Entity
@Table(name = "QLNV_KHVONPHI_TC_THOP_NCAU_CHI_NSNN_GD3N")
@Data
public class QlnvKhvonphiTcThopNcauChiNsnnGd3n implements Serializable {
	/**
	 *
	 */
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QLNV_KHVONPHI_TC_THOP_NCAU_CHI_NSNN_GD3N_SEQ")
	@SequenceGenerator(sequenceName = "QLNV_KHVONPHI_TC_THOP_NCAU_CHI_NSNN_GD3N_SEQ", allocationSize = 1, name = "QLNV_KHVONPHI_TC_THOP_NCAU_CHI_NSNN_GD3N_SEQ")
	private Long id;
	...
	@Column(name = "MA_NHOM_CHI_NSNN")
	private String maNhomChiNsnn;
