...
@Entity
@Table(name = "QLNV_KHVONPHI_DM_VONDT_XDCBGD3N")
@Data
public class QlnvKhvonphiDmVondtXdcbgd3n implements Serializable{
	/**
	 *
	 */
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QLNV_KHVONPHI_DM_VONDT_XDCBGD3N_SEQ")
	@SequenceGenerator(sequenceName = "QLNV_KHVONPHI_DM_VONDT_XDCBGD3N_SEQ", allocationSize = 1, name = "QLNV_KHVONPHI_DM_VONDT_XDCBGD3N_SEQ")
	private Long id;
	...
	@Column(name = "MA_KHOACH")
	private Long maKhoach;
	@Transient
	private String tenMaKhoach;

	@Column(name = "MA_KHOI_DAN")
	private Long maKhoiDan;
	@Transient
	private String tenMaKhoiDan;

	@Column(name = "MA_DDIEM_XD")
	private Long maDdiemXd;
	@Transient
	private String tenMaDdiemXd;

	@Column(name = "DDIEM_MO_TAIKHOAN")
	private String ddiemMoTaikhoan;

	@Column(name = "MASO_DAN")
	private String masoDan;

	@Column(name = "MA_NGANH_KTE")
	private Long maNganhKte;
	@Transient
	private String tenMaNganhKte;
	...
	@Column(name = "QD_DUYET_TK_DTOAN_CK")
	private Long qdDuyetTkDtoanCk;
