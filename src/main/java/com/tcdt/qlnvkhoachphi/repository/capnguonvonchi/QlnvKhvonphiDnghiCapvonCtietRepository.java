...
@Repository
public interface QlnvKhvonphiDnghiCapvonCtietRepository extends CrudRepository<QlnvKhvonphiDnghiCapvonCtiet, Long>{
	...
	ArrayList<QlnvKhvonphiDnghiCapvonCtiet> synthesis(String maDviCha,String namHienHanh);

	@Transactional
	@Modifying
	@Query(value = "DELETE FROM QLNV_KHVONPHI_DNGHI_CAPVON_CTIET u WHERE u.ID in ?1", nativeQuery = true)
