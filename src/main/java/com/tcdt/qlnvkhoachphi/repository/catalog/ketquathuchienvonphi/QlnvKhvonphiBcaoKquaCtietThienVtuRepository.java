...
public interface QlnvKhvonphiBcaoKquaCtietThienVtuRepository extends CrudRepository <QlnvKhvonphiBcaoKquaCtietThienVtu, Long>{
	String qlnvKhvonphiBcaoKquaCtietThienVtuPhiNhapMua = "SELECT * FROM QLNV_KHVONPHI_BCAO_KQUA_CTIET_THIEN_VTU_PHI_NHAP_MUA t "
			+ "WHERE t.QLNV_KHVONPHI_BCAO_KQUA_CTIET_THIEN_PHI_NHAP_MUA_ID = :qlnvKhvonphiBcaoKquaCtietThienPhiNhapMuaId ";
	...
	ArrayList<QlnvKhvonphiBcaoKquaCtietThienVtu> synthesis(String maDviCha, String namHienHanh);

	@Query(value = qlnvKhvonphiBcaoKquaCtietThienVtuPhiNhapMua, nativeQuery = true)
	ArrayList<QlnvKhvonphiBcaoKquaCtietThienVtu> findQlnvKhvonphiBcaoKquaCtietThienVtuPhiNhapMuaByQlnvKhvonphiBcaoKquaCtietThienPhiNhapMuaId(Long qlnvKhvonphiBcaoKquaCtietThienPhiNhapMuaId);

	@Transactional
	@Modifying
	@Query(value = "DELETE FROM QLNV_KHVONPHI_BCAO_KQUA_CTIET_THIEN_VTU_PHI_NHAP_MUA u WHERE u.ID in ?1", nativeQuery = true)
